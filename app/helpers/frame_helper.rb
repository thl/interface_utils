module FrameHelper
  ...
  def frame_css
    if in_frame?
      ...
      else css_url = "#{InterfaceUtils::Server.get_url}/global/css/thdl-style.css" #temporary solution
      end
  ...
  def www_js
    return javascript_include_tag "#{InterfaceUtils::Server.get_url}/global/php/combineJS.php" if in_frame?
  end
